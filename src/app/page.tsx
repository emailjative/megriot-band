    ...
    <>
      ...
      <section className="relative min-h-[80vh] md:h-screen flex flex-col items-center justify-center px-4 pt-16">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-9xl font-black tracking-tighter uppercase mb-4 md:mb-6 text-white drop-shadow-lg">
            Meg Riot
          </h2>
          <p className="text-base md:text-xl text-white/80 max-w-md mx-auto mt-6 md:mt-8 drop-shadow">
      ...
      <section id="band" className="section-overlay relative py-20 md:py-32 px-4 md:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-xl text-white/80 leading-relaxed mb-10 md:mb-16 max-w-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
            {members.map((member) => (
              <div key={member.name} className="p-4 md:p-6 rounded-2xl bg-black/50 border border-white/10">
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-zinc-600 to-zinc-800 mb-3 md:mb-4 flex items-center justify-center text-xl md:text-2xl font-bold">
                  {member.name[0]}
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3 md:space-y-4">
            <a href="https://instagram.com/megriotband" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-4 p-5 md:p-8 rounded-2xl bg-black/50 border border-white/10 hover:border-white/20 transition-colors">
      ...
      <section id="tour" className="section-overlay relative py-20 md:py-32 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-5 md:p-8 rounded-2xl bg-black/50 border border-white/10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-0">
              <div className="flex items-center gap-5 md:gap-8">
                ...
                <div>
                  <p className="text-xl md:text-2xl font-semibold">Punks &amp; Pints</p>
                  <p className="text-white/60 text-sm md:text-base">Fermentage Brewpub</p>
                </div>
              </div>
              <button className="w-full md:w-auto px-6 py-3 rounded-full bg-white text-black font-semibold text-sm hover:bg-zinc-200 transition-colors">
                Tickets Local Only
              </button>
            </div>
          </div>
      ...
      <section id="merch" className="section-overlay relative py-20 md:py-32 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
            <div className="rounded-2xl md:rounded-3xl bg-black/50 border border-white/10 overflow-hidden">
              ...
              <div className="p-5 md:p-8">
                ...
                <p className="text-white/60 mb-4">15 &euro;</p>
                <a href="https://instagram.com/megriotband" target="_blank" rel="noopener noreferrer"
      ...
      <section id="contact" className="section-overlay relative py-20 md:py-32 px-4 md:px-6 border-t border-white/10">
        <div className="max-w-4xl mx-auto">
          ...
          <form className="max-w-xl space-y-4 md:space-y-6">
            <input type="text" placeholder="Name"
              className="w-full p-3 md:p-4 rounded-xl bg-black/50 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-white/30 transition-colors" />
            <input type="email" placeholder="Email"
              className="w-full p-3 md:p-4 rounded-xl bg-black/50 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-white/30 transition-colors" />
            <textarea placeholder="Message" rows={4}
              className="w-full p-3 md:p-4 rounded-xl bg-black/50 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-white/30 transition-colors resize-none" />
            <button type="submit"
              className="w-full md:w-auto px-8 py-3 md:py-4 rounded-full bg-white text-black font-semibold hover:bg-zinc-200 transition-colors">
              Send Message
            </button>
          </form>
        </div>
      ...
      <footer className="py-8 md:py-12 px-4 md:px-6 border-t border-white/10 text-center text-xs md:text-sm text-white/50">
